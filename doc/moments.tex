...
$$\frac{1}{4 N} \left(\delta_{i,0} \phi(0,t) +\delta_{i,n} \phi(1,t)   \right)+\int \pd{w_i}{x} x (1-x) \phi(x,t).$$
...
\begin{equation}
\begin{split}
\frac{1}{4 N} \left(\delta_{i,0} \phi(0,t) +\delta_{i,n} \phi(1,t)   \right)\\
+(i-1)(n-i+1) \Phi_s (i-1) \delta_{i\geq 2}\\
-2 i(n-i) \Phi_s(i) \delta_{1\leq i \leq n-1}  \\ + (n-i-1)(i+1) \Phi_s(i+1)  \delta_{i\leq n-2}  
\end{split}
\end{equation}
...
$$\sum_i 2 N_i \frac{\delta(x_i-2 N_i)}{\delta(x_i)} \prod_j \delta(x_j)$$.
