...
\section{Bidirectional splitting}
...
To overcome this problem, we split the resolution by pairs of dimensions or populations so we can deal with the diagonal terms (see Fig. ). 
 \begin{figure}[h]
\centering
	\begin{tikzpicture}
