...
def _object_func(params, data_list, model_func, rhos=[0],
...
def optimize_log_fmin(p0, data_list, model_func, rhos=[0],
                        lower_bound=None, upper_bound=None,
    ...
    args = (data_list, model_func, rhos, lower_bound, upper_bound, verbose,
